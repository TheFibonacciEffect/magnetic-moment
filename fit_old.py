...
# np.polyfit
plt.plot(1/df_front['distance[mm]'][1:],df_front['cube flux density [T]'][1:],"o")

coefficients_cube = np.polyfit(1/df_front['distance[mm]'][1:],df_front['cube flux density [T]'][1:],3)
# coefficients_big_cylinder = np.polyfit(1/df_front['distance[mm]'][1:],df_front['big cylinder flux density [T]'],3)
# coefficients_small_cylinder = np.polyfit(1/df_front['distance[mm]'][1:],df_front['small cylinder flux density [T]'],3)

plt.plot(1/df_front['distance[mm]'][1:],np.polyval(coefficients_cube,1/df_front['distance[mm]'][1:]))
# plt.plot(1/df_front['distance[mm]'][1:],np.polyval(coefficients_big_cylinder,1/df_front['distance[mm]'][1:]))
# plt.plot(1/df_front['distance[mm]'][1:],np.polyval(coefficients_small_cylinder,1/df_front['distance[mm]'][1:]))
...
plt.plot(df_front['distance[mm]'],coefficients_cube[0]*df_front['distance[mm]']**(-3.)+coefficients_cube[3])
...
popt_cube, pcov_cube = curve_fit(Bz, df_front['distance[mm]'], df_front['cube flux density [T]'], p0=coefficients_cube[0]*(4*np.pi)/(const.mu_0*2))
